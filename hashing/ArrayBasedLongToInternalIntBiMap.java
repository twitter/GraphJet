...
public class ArrayBasedLongToInternalIntBiMap implements LongToInternalIntBiMap {
  ...
  public ArrayBasedLongToInternalIntBiMap(
    ...
    numStoredKeysCounter = scopedStatsReceiver.counter0("numStoredKeys");
    numFixedLengthMapsCounter = scopedStatsReceiver.counter0("numFixedLengthMaps");
    totalAllocatedArrayBytesCounter = scopedStatsReceiver.counter0("allocatedArrayBytes");
    initialize();
  }
