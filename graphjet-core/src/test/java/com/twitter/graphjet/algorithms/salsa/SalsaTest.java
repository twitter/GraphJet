...
public class SalsaTest {
  ...
  private void testSalsaWithGraph(BipartiteGraph bipartiteGraph) {
    ...
    expectedTopResults.add(new RecommendationInfoTweet(5, 0.2346316283435007, socialProof.get(0)));
    expectedTopResults.add(new RecommendationInfoTweet(2, 0.22430783669638668, socialProof.get(1)));
    expectedTopResults.add(new RecommendationInfoTweet(4, 0.20835288596902862, socialProof.get(2)));
    ...
    expectedTopResultsSubgraph.add(
      new RecommendationInfoTweet(5, 0.3561333333333357, subSocialProof.get(0)));
    expectedTopResultsSubgraph.add(
      new RecommendationInfoTweet(2, 0.29866666666666786, subSocialProof.get(1)));
    expectedTopResultsSubgraph.add(
      new RecommendationInfoTweet(4, 0.2906666666666677, subSocialProof.get(2)));
  ...
  public void testSalsaWithRandomGraph() throws Exception {
    ...
    final List<RecommendationInfo> expectedTopResults = new ArrayList<RecommendationInfo>();
    expectedTopResults.add(new RecommendationInfoTweet(735, 0.0010926365795724466,
      socialProof.get(0)));
    expectedTopResults.add(new RecommendationInfoTweet(119, 0.0010451306413301663,
      socialProof.get(1)));
    expectedTopResults.add(new RecommendationInfoTweet(70, 0.0010451306413301663,
      socialProof.get(2)));
  ...
  public void testSalsaWithLargeGraph() throws Exception {
    ...
    expectedTopResults.add(
      new RecommendationInfoTweet(704, 0.0037072243346007606, socialProof.get(0)));
    expectedTopResults.add(
      new RecommendationInfoTweet(509, 0.003326996197718631, socialProof.get(1)));
    expectedTopResults.add(
      new RecommendationInfoTweet(190, 0.003279467680608365, socialProof.get(2)));
