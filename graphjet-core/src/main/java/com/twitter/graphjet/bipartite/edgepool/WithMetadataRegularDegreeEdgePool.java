...
public class WithMetadataRegularDegreeEdgePool extends AbstractRegularDegreeEdgePool {
   ...
   *                          if this is violated.
   */
  public WithMetadataRegularDegreeEdgePool(
    int expectedNumNodes,
    int maxDegree,
    StatsReceiver statsReceiver
  ) {
    super(expectedNumNodes, maxDegree, statsReceiver.scope("WithMetadataRegularDegreeEdgePool"));
