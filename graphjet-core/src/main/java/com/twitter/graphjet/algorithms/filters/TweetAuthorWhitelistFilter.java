...
/**
 * This filter only permits tweets authored by the given list of whitelist userIds
 * However, if the whitelist is left unspecified or empty, no tweet will be filtered.
 */
public class TweetAuthorWhitelistFilter extends TweetAuthorFilterBase {
  public TweetAuthorWhitelistFilter(
